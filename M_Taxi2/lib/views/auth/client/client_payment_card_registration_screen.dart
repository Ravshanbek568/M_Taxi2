...
import 'package:m_taksi/views/auth/client/client_terms_screen.dart'; // Mijoz shartlari ekrani

/// TO'LOV KARTASI RO'YXATDAN O'TKAZISH EKRANI (MIJOZLAR UCHUN)
/// 
/// Bu ekran mijozlarga to'lov kartasi ma'lumotlarini kiritish imkoniyatini beradi.
/// Karta raqami, amal qilish muddati va CVV kodini o'z ichiga oladi.
class ClientPaymentCardScreen extends StatefulWidget {
  const ClientPaymentCardScreen({super.key});

  @override
  State<ClientPaymentCardScreen> createState() => _ClientPaymentCardScreenState();
}
...
class _ClientPaymentCardScreenState extends State<ClientPaymentCardScreen> {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const ClientTermsScreen(), // Mijoz shartlari sahifasiga o'tish
                          ),
                        );
                      },
                      child: const Text(
  ...
  void _onConfirmPressed() {
    ...
    if (_cardNumberController.text.isNotEmpty &&
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const ClientTermsScreen(), // Mijoz shartlari sahifasiga o'tamiz
        ),
      );
    }
  }
